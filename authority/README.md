...
Authority could use with [Auth](http://github.com/germla/auth) to get current user, handle sessions, you could use it, or implement your own [AuthInterface](http://godoc.org/github.com/germla/auth/authority#AuthInterface)

```go
import (
  "github.com/germla/auth"
  "github.com/germla/auth/authority"
...
Authority provides some [Rules](http://godoc.org/github.com/germla/auth/authority#Rule) to make you define them easily, used like:
